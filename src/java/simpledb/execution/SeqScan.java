...
public class SeqScan implements OpIterator {
    ...
    public TupleDesc getTupleDesc() {
        // some code goes here
        TupleDesc oriTd = Database.getCatalog().getTupleDesc(this.tableId);
        Type[] types = new Type[oriTd.numFields()];
        String[] fieldNames = new String[oriTd.numFields()];
        for (int i = 0; i < oriTd.numFields(); i++){
            types[i] = oriTd.getFieldType(i);
            fieldNames[i] = this.tableAlias + "." + oriTd.getFieldName(i);
        }
